...
class Member extends Base{
	...
	public function login(){
		...
		if(checkForm('email',$username)){
			$member=Db::name('user')->where(array('email'=>$username,'role'=>array('in',"'user','member'")))->find();
		}else{
			$member=Db::name('user')->where(array('username'=>$username,'role'=>array('in',"'user','member'")))->find();
		}
