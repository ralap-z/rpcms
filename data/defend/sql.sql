...
CREATE TABLE IF NOT EXISTS `%pre%logs` (
  ...
  `tages` varchar(255) CHARACTER SET utf8 NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `%pre%user` (
  ...
  `failureNum` TINYINT UNSIGNED NULL DEFAULT '0' COMMENT '失败次数',
  `sessionToken` VARCHAR(32) NULL DEFAULT '' COMMENT 'session标识',
